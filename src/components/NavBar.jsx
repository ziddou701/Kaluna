  ...
  return (
    ...
    <div class="hidden md:flex items-center bg-zinc-50 border border-zinc-200 rounded-full px-1 py-1 ml-auto">
        <div class="hidden md:flex items-center px-3 py-1 ml-auto mr-2 gap-2">
            ...
            <a href="#" class="px-4 py-1.5 rounded-full text-sm transition-colors text-shadow-gray-500 hover:text-indigo-800">Services</a>
            <a href="#" class="px-4 py-1.5 rounded-full text-sm transition-colors text-shadow-gray-500 hover:text-indigo-800">Pricing</a>
